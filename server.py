...
def run(
    server_class=HTTPServer, handler_class=CORSRequestHandler, port=8000, directory=None
):
    if directory:
        os.chdir(directory)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, help="Port to server HTTP on", default=8888)
